const wordbank = [
    ...
    "ADMIRING THE SUN SETTING OVER THE PACIFIC",
    ...
    "BOOSTING MORALE",
    "BORROWING A BOOK",
    "BORROWING A CUP OF SUGAR FROM MY NEIGHBORS",
    ...
    "BROWSING FOR SOUVENIRS AND KEEPSAKES",
    ...
    "BURYING MY FEET IN THE WARM SAND",
    ...
    "CAMPING AT CAMP LOOKOUT STATE PARK",
    ...
    "CELEBRATING AT MY FAVORITE RESTUARANT",
    "CELEBRATING BIG",
    ...
    "CHANGING MY PROFILE PICTURE ON FACEBOOK",
    "CHANGING MY STORY",
    ...
    "CHECKING THE DAILY SURF REPORT",
    "CHECKING THE MAIL",
    ...
    "CHILLING OUT IN A SWAYING HAMMOCK",
    ...
    "CLEANING OUT THE CLUTTER SHOULD BE ADDED",
    ...
    "CLIMBING THE STAIRS",
    "CLIMBING TO THE TOP OF MOUNT FIJI",
    "CLIMBING TO THE TOP OF MOUNT FUJI",
    "CLIMBING TO TO TOP OF MOUNT FUJI",
    ...
    "COLLECTING SEASHELLS AND CORAL",
    ...
    "COUNTING MY MONEY",
    "COUNTING MY NUMBER OF VACATION DAYS",
    "COUNTING MY STEPS",
    ...
    "CURLING UP IN THE FRONT OF THE FIRE",
    "CURLING UP WITH A GOOD BOOK",
    "CUTTING A BIRITHDAY CAKE",
    ...
    "DIGGING DEEP",
    "DIGGING INTO A BOWL OF GUACAMOLE",
    ...
    "DRYING MY WETSUIT",
    "DUCKING THE ISSUE",
    "DURING GREEN THE CHICAGO RIVER",
    ...
    "EATING DELIOUS RUSSIAN MEAT DUMPLINGS",
    "EATING DEVILED EGGS",
    "EATING DINNER",
    ...
    "ENJOYING A MASSAGE",
    "ENJOYING A MYRIAD OF OUTDOOR ACTIVITES",
    "ENJOYING A MYRIAD OF OUTDOOR ACTIVITIES",
    "ENJOYING A PICNIC AT THE VINEYARD",
    ...
    "ENJOYING AN AFTERNOON SIESTA IN A HAMMOCK",
    ...
    "ENJOYING OCEANSIDE SPA TREATMENTS",
    ...
    "ENJOYING SCRUMPTOUS APPETIZERS",
    ...
    "ESCAPING THE WINTER",
    "ESCAPING TO A TROPICAL LOCATION",
    ...
    "FEELING THE WARM TROPICAL BREEZE",
    ...
    "FILING A LAWSUIT",
    "FILING A TAX RETURN",
    "FILING OUT A COLLEGE APPLICATION",
    ...
    "FILLING THE COLLISEUM WITH WATER",
    ...
    "FINISHING OFF THE CHIPS AND SALSA",
    "FINISHING STRONG",
    "FIRING UP THE GRILL",
    ...
    "FLYING FIRST CLASS",
    "FLYING HOME TO SUPRISE MY PARENTS",
    ...
    "FOLLOW MY FAVORITE ACTORS<BR /> ON INSTAGRAM",
    ...
    "FUNDRAISING FOR A CONGRESSIONAL CANIDATE",
    "GAINING ALTITUDE",
    "GAINING FAITH",
    "GAINING MOMENTUM",
    ...
    "GATHERING AROUND A ROARING FIRE",
    ...
    "HANDSPINNING WOOL",
    "HANDSTANDS SOMERSAULTS AND BACKFLIPS",
    ...
    "KICKING BACK IN A PRIVATE CABANA",
    "KICKING BACK IN MY CABANA",
    "KICKING BACK IN THE JACUZZI",
    "KICKING BACK ON MY BEACH TOWEL",
    ...
    "LOOKING FOR BREAKING NEWS ON THE INTERNET",
    ...
    "MAKING THE AUDIENCE CLICK LIKE CHICKEN",
    ...
    "ORDERING ROOM SERVICE TO MY SUITE",
    ...
    "PASSING THE BATON",
    "PATRONIZING MY FAVORITE RESTARAUNT",
    ...
    "PLAID JACKET",
    "PLANING MY NEXT GETAWAY VACATION",
    "PLANINNG AN EVENT",
    "PLANNING A COOKOUT",
    "PLANNING A DATE",
    ...
    "PLAYING A NEW GAME",
    "PLAYING A NEW SONG ON MY UKULELE",
    ...
    "PROCESSING AN ORDER",
    "PROGRAMMING YOUR DIGITAL VIDEO RECORDER",
    "PROPOSING A TOAST",
    "PROPOSING MARRIAGE",
    ...
    "PUTTING ON A NEW PAIR OF SKI BOOTS",
    ...
    "READING THE SAN FRANSISCO CHRONICLE",
    ...
    "READING ULYSSES BY A JAMES JOYCE",
    ...
    "RELAXING IN A POOLSIDE CABANA",
    "RELAXING IN THE AIRPORT LOUNGE",
    "RELAXING IN THE WARM SUN",
    "RELAXING POOLSIDE",
    "RELAXING UNDER A BEACH UMBRELLA",
    "RELAXING UNDER THE CARIBBEAN SUN",
    "RELAXING UNDER THE MIDDAY SUN",
    ...
    "REQUESTING EXTENDED SHORE LEAVE",
    ...
    "RIDING A BUS",
    "RIDING A CABLE CAR",
    "RIDING A CABLE CAR ACROSS TOWN",
    ...
    "RIDING A FINE BUGGY THROUGH THE SAND",
    ...
    "SCRATCHING MY ELBOW",
    "SCRATCHING MY KNEE",
    "SCRATTERIMG STRAW ON A BARN FLOOR",
    ...
    "SEEING THE SIGHTS OF SOUTH BEACH",
    "SEEING THE SIGHTS ON THE LAS VEGAS STRIP",
    ...
    "SHARING A MEAL",
    "SHARING A MILKSHAKE",
    "SHARING A PITCHER OF MARGARITAS",
    "SHARING A RIDE",
    ...
    "SHARING DIGITAL PHOTOS OF MY VACATION",
    "SHARING EQUALLY",
    "SHARING MAKEUP TIPS",
    ...
    "SIPPING A COLD DRINK BY THE POOL",
    ...
    "SIPPING A MARGARITA",
    "SIPPING A MARGARITA ON THE BALCONY",
    ...
    "SKIING THROUGH FRESH POWDER SNOW",
    "SKIMMING OFF THE FAT",
    "SKIMMING THROUGH A GUIDEBOOK",
    ...
    "SOAKING IN SOME SUN",
    "SOAKING IN THE AWESOME SCENERY",
    "SOAKING IN THE SIGHTS",
    "SOAKING IN THE SPECTACULAR SCENERY",
    "SOAKING IN THE SUN",
    "SOAKING IN THE TUB",
    ...
    "SOAKING UP THE RAYS",
    "SOAKING UP THE SUN ALONG THE COAST OF GREEC",
    ...
    "SPENDING THE ENTIRE DAY AT THE SPA",
    ...
    "STROLLING BAREFOOT ALONG THE BEACH",
    ...
    "TAKING A LIMO",
    "TAKING A LIMOUSINE TO THE PROM",
    "TAKING A LOCAL TOUR",
    "TAKING A LONG BATH",
    ...
    "TAKING MY KIDS TO THE CHILDRENS MUESEUM",
    ...
    "TAKING PICTURES WITH AN UNDERWATER CAMERA",
    ...
    "TOURING COASTAL FISHING VILLAGES",
    ...
    "TOURING THE BACKCOUNRTY ON A SNOWMOBILE",
    ...
    "UNANIMOUS VERDICT",
    "UNCLOGGING A DRAIN",
    "UNCORKING A BOTTLE OF VINTAGE WINE",
    ...
    "UNWINDING IN A SPA",
    "UNWINDING WITH A STROLL ON THE BEACH",
    ...
    "WALKING DOWN THE FASION RUNWAY",
    ...
    "WALKING UP TO THE SOUND OF WAVES",
    "WALKING UPRIGHT",
    ...
    "WATCHING ALL THE EPISODES OF FRIDAY<BR /> NIGHT LIGHTS",
    ...
    "WAXING MY SNOWBOARD",
    "WAXING MY SURFBOARD",
    "WEARING A BEAUTIFUL FLOWER LEI",
    ...
    "WEARING MY FAVORITE ALOHA SHIRT",
    ...
    "WRITING A PAPER WHEN WHAT I DID LAST SUMMER",
    "WRITING A POEM",
